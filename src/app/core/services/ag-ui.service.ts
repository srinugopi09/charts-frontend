...
export class AgUiService {
  ...
  /** Emits after every successful agent run (from onRunFinalized) */
  private readonly _runCompleted$ = new Subject<void>();
  readonly runCompleted$ = this._runCompleted$.asObservable();
